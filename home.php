...
<body>
            ...
            <div class="review-card">
                <div class="review-info">
                    <div class="review-details">
                        ...
                        <p class="review-text">"Tolle Auswahl an Fahrzeugen und exzellenter Service! Ich bin sehr zufrieden."</p>
                    </div>
                </div>
            </div>
            <div class="review-card">
    ...
    <div class="aboutUs-container">
        <div class="aboutUs">
            <div id="map" style="width: 30%; height: 400px; border-radius: 5px 0px 5px 0px;"></div>
            <script>
        ...
        var marker = L.marker([53.547425386544006, 9.987030559633626], { icon: customIcon }).addTo(map);
        ...
        // Adding layer to the map
            ...
            <div class="content-box">
                ...
                <div class="text-content">
                    <h2>Das sind wir!</h2>
                    <p>Willkommen bei RentEase! Wir, fünf engagierte Studierende aus Hamburg, haben RentEase als unser Uni-Projekt gestartet. Unsere Autovermietung bietet maßgeschneiderte Lösungen für Ihre Mobilitätsanforderungen. Von Stadtfahrten bis hin zu Familienausflügen und Geschäftsreisen oder Umzügen – wir haben das passende Fahrzeug für Sie..</p>
                </div>
            </div>
        </div>
    </div>
